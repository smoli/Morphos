  ...
  agents.jobs = [
    {
      ...
      label: 'Rechner', prompt: 'Wurzel ziehen', attachments: [], cancelled: false,
    },
    {
      jobId: 'job-2', appKey: 'notizen', state: 'queued', instanceId: 'w2', appId: 'notizen',
      label: 'Notizen', prompt: 'Suche einbauen', attachments: [], cancelled: false,
    },
    {
      jobId: 'job-3', appKey: 'uhr', state: 'queued', instanceId: 'w3', appId: 'uhr',
      label: 'Uhr', prompt: 'Wecker', attachments: [], cancelled: false,
    },
  ];
}
